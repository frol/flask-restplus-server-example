...
def upgrade():
    ...
    with op.batch_alter_table('asset', schema=None) as batch_op:
        batch_op.add_column(sa.Column('magic_signature', sa.String(), nullable=True))
        batch_op.execute('UPDATE asset SET magic_signature = ""')
        batch_op.alter_column('magic_signature', nullable=True)
